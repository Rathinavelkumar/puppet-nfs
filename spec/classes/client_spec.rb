...
describe 'olnfs::client' do
  ...
  context "operatingsysten => gentoo" do
    ...
    it { should contain_class('olnfs::client::gentoo') }
  end
  context "operatingsystem => darwin" do
    ...
    it do
      ...
      }.to raise_error(Puppet::Error, /olnfs client is not supported on Darwin/)
    end
  end
end
